...
class Technosclub extends StatefulWidget {
  const Technosclub({Key? key}) : super(key: key);

  @override
  State<Technosclub> createState() => _TechnosclubState();
}

class _TechnosclubState extends State<Technosclub> {
  @override
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              const TitleDetail(title: "Coordinator", detail: "Ram Kumar"),
