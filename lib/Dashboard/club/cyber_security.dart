...
class Cyberclub extends StatefulWidget {
  const Cyberclub({Key? key}) : super(key: key);

  @override
  State<Cyberclub> createState() => _CyberclubState();
}

class _CyberclubState extends State<Cyberclub> {
  @override
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
                  ...
                  Container(
                    ...
                    decoration: const BoxDecoration(
                      image: DecorationImage(
                        fit: BoxFit.cover,
                        image: AssetImage("assets/Cyber Security.jpg"),
              ...
              const TitleDetail(title: "Coordinator", detail: "Anees"),
