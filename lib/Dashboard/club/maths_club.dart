...
class Mathsclub extends StatefulWidget {
  const Mathsclub({Key? key}) : super(key: key);

  @override
  State<Mathsclub> createState() => _MathsclubState();
}

class _MathsclubState extends State<Mathsclub> {
  @override
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              const TitleDetail(title: "Coordinator", detail: "Hari Prasad"),
